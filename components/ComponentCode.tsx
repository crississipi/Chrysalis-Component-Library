...
`;
  ...
  return (
    <div className='w-full aspect-[3/2] rounded-xl rounded-tr-none bg-black overflow-hidden relative'>
      ...
      <div className='h-full w-full tracking-wider text-xs text-white overflow-x-hidden mt-7'>
        <pre className={preStyle ?? 'h-max w-max overflow-y-hidden p-3 leading-3'}>
